...
JNIEXPORT jint JNICALL Java_xeffyr_alpine_term_terminal_JNI_createSubprocess(
        JNIEnv* env,
...
JNIEXPORT void JNICALL Java_xeffyr_alpine_term_terminal_JNI_setPtyWindowSize(JNIEnv* ALPINE_TERM_UNUSED(env), jclass ALPINE_TERM_UNUSED(clazz), jint fd, jint rows, jint cols)
{
    struct winsize sz = { .ws_row = rows, .ws_col = cols };
    ioctl(fd, TIOCSWINSZ, &sz);
}

JNIEXPORT void JNICALL Java_xeffyr_alpine_term_terminal_JNI_setPtyUTF8Mode(JNIEnv* ALPINE_TERM_UNUSED(env), jclass ALPINE_TERM_UNUSED(clazz), jint fd)
{
    struct termios tios;
    tcgetattr(fd, &tios);
...
JNIEXPORT int JNICALL Java_xeffyr_alpine_term_terminal_JNI_waitFor(JNIEnv* ALPINE_TERM_UNUSED(env), jclass ALPINE_TERM_UNUSED(clazz), jint pid)
{
    int status;
...
JNIEXPORT void JNICALL Java_xeffyr_alpine_term_terminal_JNI_close(JNIEnv* ALPINE_TERM_UNUSED(env), jclass ALPINE_TERM_UNUSED(clazz), jint fileDescriptor)
{
